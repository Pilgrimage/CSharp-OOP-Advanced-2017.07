...
public class AxeTests
{
    ...
    [Test]
    public void AxeDurabilityPointsInitialize()
    {
        //Assert
        Assert.AreEqual(1, this.axe.DurabilityPoints);
    }

    [Test]
    public void AxeAttackPointsInitialize()
    {
        //Assert
        Assert.AreEqual(1, this.axe.AttackPoints);
    }
