namespace p08_PetClinics.Entities
{
    using System;
    using System.Text;
    ...
    public class Clinic
    {
        ...
        {
            // 4 ; 3 ; 5 ; 2 ; 6 ; 1 ; 7 ; 0 ; 8  // needed sequence of rooms
            // 0  -1  +2  -3  +4  -5  +6  -7  +8  // increment relative previous index
            // 0  -1  +1  -2  +2  -3  +3  -4  +4  // increment relative first index
        ...
        public override string ToString()
        {
            ...
            for (int i = 0; i < this.NumberOfRooms; i++)
            {
                //string result = (this.rooms[i] != null) ? this.rooms[i].ToString() : "Room empty";
